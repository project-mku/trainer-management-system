...
from .models import CustomUser, Trainer,TrainerSkills, Payroll, PaymentMethod, Course, Schedule, Student, Enrollment, Feedback, Manager,ManagerAuthenticationCodes, Payslip, SchoolAccount
